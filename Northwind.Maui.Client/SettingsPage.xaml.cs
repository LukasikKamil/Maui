...
public partial class SettingsPage : ContentPage
{
    ...
    private async void ContentPage_Loaded(object sender, EventArgs e)
    {
        ...
        {
            await DisplayAlert(title: "Exception", message: ex.Message, cancel: "OK");
    ...
    private async void ApplyButton_Clicked(object sender, EventArgs e)
    {
        try
        {
            App.Current.Resources[textColorKey] = Color.Parse(TextColorEntry.Text);

            App.Current.Resources[backgroundColorKey] = Color.Parse(BackgroundColorEntry.Text);
        }
        catch (Exception ex)
        {
            await DisplayAlert(title: "Exception", message: ex.Message, cancel: "OK");
    ...
    private string GetNameFromColor(Color color)
    {
        ...
        FieldInfo info = colorsType.GetFields().Where(field => field.GetValue(field) == color).SingleOrDefault();
